 ...
 * @author jean
 */
public class KeycloakAuthenticateValidatorCallbackHandler
    implements AuthenticateCallbackHandler {

    private final Logger log = LoggerFactory.getLogger(KeycloakAuthenticateValidatorCallbackHandler.class);
    ...
    private void handleCallback(OAuthBearerValidatorCallback callback) {
        ...
        final KeycloakBearerToken token = new KeycloakBearerToken(accessToken);
